        ...
        {selectedUser ? (
          <div className="flex-1 flex flex-col">
            ...
            <div className="px-4 py-3 border-b border-gray-100 flex items-center gap-3 bg-white">
              ...
              <div>
                <p className="font-semibold text-sm text-gray-900">@{selectedUser.username}</p>
              </div>
            </div>

            {/* Messages */}
            <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 bg-surface-muted">
              {loadingMessages ? (
            ...
            {/* Input */}
            <form onSubmit={handleSend} className="px-4 py-3 border-t border-gray-100 bg-white flex gap-3">
              <input
                type="text"
                value={messageText}
